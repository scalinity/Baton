...
- The phone hears Baton's own escalations only through the session itself: every session is on
  ...
  raises no alert.
- A session whose process has stopped cannot be woken from Claude.app or the phone; a message typed
  to it there is held and delivered when it is resumed on the Mac.
